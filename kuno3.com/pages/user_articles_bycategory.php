<?php include '../addons/header.php';
 ...
 $category = new User();
$cat_name = $category->getCategory($_GET['id'])['CAT_NAME'];
?>
   <div class="article-bg">
      <h1 class="w3-right"><?php print($cat_name)?></h1>
   </div>
   <div class="W3-row">
      <div class="w3-col" style="width: 100%; padding: .7em;">
         ...
         ?>
         <form action="./user_articles_bycategory.php?id=<?php $cat['CAT_ID'] ?>" method="POST">
            <a class="categos w3-card" style="margin-right: .5em;" href="./user_articles.php">#All</a>
            <?php
               foreach($category->getCategories() as $categ)
               {
            ?>

               <input type="hidden" name="category_id" value="<?php echo $categ['CAT_ID'] ?>">
